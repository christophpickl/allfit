...
1. replace screenshots in the `docs/` folder
1. execute the `bin/prod_release.sh` script
1. create a [new release in github](https://github.com/christophpickl/allfit/releases/new).
...
1. update the download links in `docs/index.html`
   1. commit, push, wait
